...
/**
 * The FeedServer class is the server that will be used to serve the feed service. This server will be responsible for
...
public class FeedServer extends ServerBase {
    ...
    Server feedServer = ServerBuilder
            ...
            .addService(new FeedServiceImpl()) // Add the service to the server.
