...
public class ReportServer {
    public static void main(String[] args) throws IOException {
        // constants
        final int SERVICE_PORT = 5053;
        final String SERVICE_TYPE = "_report._tcp.local.";
        final String SERVICE_NAME = "Report Service";
        final String SERVICE_DESCRIPTION = " Report Description";
        ...
        System.out.println("Report Server Listening for Requests...");
